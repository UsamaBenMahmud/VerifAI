...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Bangladesh's first AI-native deepfake detection. Bangla-first trust infrastructure for journalists, fact-checkers, and citizens." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "VerifAI — Detect Deepfakes in 6 Seconds" },
      { name: "twitter:description", content: "Bangladesh's first AI-native deepfake detection. Bangla-first trust infrastructure for journalists, fact-checkers, and citizens." },
    ],
    links: [
